        ...
        <footer className="w-full bg-[#FAFAF9] text-[#1C1917] border-t border-stone-300 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-stone-200">
                    ...
                    <nav className="flex flex-wrap items-center justify-center gap-6 text-xs font-mono font-semibold tracking-wider uppercase text-stone-600">
                        {footerLinks.map((link) => (
                            <a
                                key={link.name}
                                href={link.href}
                                className="hover:text-[#047857] transition-colors duration-200"
                            >
                                {link.name}
                            </a>
                        ))}
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-stone-500 gap-3">
                    ...
                    {/* <p className="text-center sm:text-right">
                        Designed & Built with <span className="text-[#047857] font-bold">React + Tailwind</span>
                    </p> */}
                </div>
